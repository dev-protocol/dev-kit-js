...
describe('createMarketGroupCaller.spec.ts', () => {
	describe('createMarketGroupCaller', () => {
		it('check return value', () => {
			...
			const result = createMarketGroupCaller(addressConfigContract)
		...
		it('call success', async () => {
			...
			// eslint-disable-next-line @typescript-eslint/no-explicit-any
			const caller = createMarketGroupCaller(addressConfigContract as any)
